#include "kernel/data/image.h"

extern "C"{
#define STB_IMAGE_IMPLEMENTATION
#include "kernel/image_process/stb_image.h"
#define STB_IMAGE_WRITE_IMPLEMENTATION
#include "kernel/image_process/stb_image_write.h"
#include <iostream>
}
...
namespace ImageFunc{
    ...
    Image* resizeImage(Image* og_data, size_t w, size_t h){
		...
		return resized; //ATTENTION dont forget to delete it.
    }
